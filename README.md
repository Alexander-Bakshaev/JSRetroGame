...
[![npm](https://img.shields.io/badge/npm-8.x-CB3837?logo=npm)](https://www.npmjs.com/)
[![Webpack](https://img.shields.io/badge/Webpack-5.x-8DD6F9?logo=webpack)](https://webpack.js.org/)
[![Babel](https://img.shields.io/badge/Babel-7.x-F9DC3E?logo=babel)](https://babeljs.io/)
...
[![JavaScript Style Guide](https://img.shields.io/badge/code_style-prettier-ff69b4.svg?logo=prettier)](https://prettier.io/)
[![MIT License](https://img.shields.io/badge/License-MIT-4BC51D.svg)](LICENSE)

## 🚀 О проекте

Retro Battle Game - это двухмерная пошаговая стратегическая игра в стиле фэнтези, где игрок управляет командой героев, сражающихся с полчищами нечисти. Игра была разработана в рамках итоговой работы курса «Продвинутый JavaScript» от Нетологии.

## 📦 Установка и запуск

1. Клонируйте репозиторий:
```bash
git clone https://github.com/Alexander-Bakshaev/JSRetroGame.git
cd JSRetroGame
```
...
- Развитие и прокачка персонажей
- Разнообразие классов с уникальными способностями
- Интеллектуальный ИИ противника
- Система сохранения/загрузки игры

### Управление
- **ЛКМ** - выбор/перемещение/атака персонажа
- **Наведение на ячейку** - просмотр характеристикобновлять
- **New Game** - начать новую игру
- **Save Game** - сохранить текущий прогресс
- **Load Game** - загрузить последнее сохранение

## 🏗 Архитектура

### Ключевые компоненты
- **GameController** - основной класс, управляющий игровым процессом
- **GamePlay** - отвечает за взаимодействие с DOM и визуальное отображение
- **Character** - базовый класс для всех персонажей
- **PositionedCharacter** - связывает персонажа с позицией на поле
- **Team** - управление командой персонажей
- **GameState** - хранение состояния игры
- **GameStateService** - работа с сохранениями (localStorage)

## 🎯 Особенности реализации

### 🎭 Классы персонажей

| Класс     | Тип      | Атака | Защита | Движение | Радиус атаки | Особенность           |
|-----------|----------|-------|--------|----------|--------------|-----------------------|
| 🏹 Bowman    | Игрок   | 25    | 25     | 2        | 2            | Точно бьёт на расстоянии |
| ⚔️ Swordsman | Игрок   | 40    | 10     | 4        | 1            | Сильная атака вблизи    |
| 🔮 Magician  | Игрок   | 10    | 40     | 1        | 4            | Мощные заклинания       |
| 🧛 Vampire   | Враг    | 25    | 25     | 2        | 2            | Восстанавливает здоровье|
| 💀 Undead    | Враг    | 40    | 10     | 4        | 1            | Устойчив к контролю     |
| 👹 Daemon    | Враг    | 10    | 10     | 1        | 4            | Наносит урон через броню|

### 🛠 Технический стек
- **JavaScript (ES6+)** - основной язык разработки
- **Node.js 16+** - среда выполнения
- **npm 8+** - менеджер пакетов
- **Webpack 5** - сборка проекта
- **Babel 7** - транспиляция кода
- **Jest 29** - модульное тестирование
- **ESLint 8** - линтинг кода
- **Webpack Dev Server 4** - сервер для разработки
- **Core-JS 3** - полифиллы для JavaScript
...
<div align="center">
  <p>Сделано с ❤️ для курса «Продвинутый JavaScript» от Нетологии</p>
</div>
